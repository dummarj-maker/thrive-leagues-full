...
export default function Home() {
  return (
    <div className="appShell">
      {/* This wrapper intentionally keeps a "desktop width" so mobile can pinch-zoom.
          No stacking, no zoom UI. */}
      <div className="fixedDesktopCanvas">
        <header className="topBar">
          ...
          <nav className="nav">
            ...
            <a className="navLink" href="#">Playbook</a>
            <a className="navLink" href="#">Commissioner Tools</a>
            <a className="navLink" href="#">Achievements</a>
            <a className="navLink" href="#">Badges</a>
          </nav>

          <div className="topRight">
            <Pill>Season 2026</Pill>
            <button className="btnPrimary" type="button">New Challenge</button>
          </div>
        </header>
        ...
        <main className="grid">
          ...
          <aside className="col left">
            <Card
              title="My Team"
              right={<button className="iconBtn" title="Settings">⚙️</button>}
            >
          ...
          <aside className="col right">
            <Card
              ...
              right={<a className="link" href="#">All</a>}
            >
            ...
            <Card
              ...
              right={<a className="link" href="#">Full</a>}
            >
              <ol className="leaderboard">
                {leaderboard.map((p) => (
                  <li key={p.name} className="row">
                    <span className="rowLeft">
                      <span className="rank">{String(leaderboard.indexOf(p) + 1).padStart(2, "0")}</span>
